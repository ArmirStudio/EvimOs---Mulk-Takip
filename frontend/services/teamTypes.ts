...
export type TeamMessageAttachmentKind = 'image' | 'document' | 'file';
...
export type TeamMessageAttachmentInput = {
  bucket: 'team-message-files';
  storage_path: string;
  file_name: string;
  mime_type: string;
  size_bytes?: number | null;
  kind: TeamMessageAttachmentKind;
};

export type TeamMessageAttachment = TeamMessageAttachmentInput & {
  id: string;
  message_id: string;
  office_owner_id: string;
...
export type TeamMessageAttachmentDraft = {
  id: string;
  uri: string;
  name: string;
  mimeType: string;
