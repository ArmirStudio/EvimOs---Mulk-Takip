            ...
            <Animated.View entering={FadeInDown.delay(180).duration(500)} style={s.sectionPx}>
              <View style={s.maintenancePanelCard}>
                <View style={s.maintenancePanelHeader}>
                  <View>
                    <Text style={s.chartTitle}>Bakım merkezi</Text>
                    <Text style={s.maintenancePanelSub}>İlk aksiyon, saha işlemi ve kiracı onayı aynı yerde.</Text>
                  </View>
                ...
                <View style={s.maintenanceSummaryRow}>
                  <View style={s.maintenanceSummaryChip}>
                    ...
                    <Text style={s.maintenanceSummaryLabel}>İlk aksiyon</Text>
                  </View>
                  <View style={s.maintenanceSummaryChip}>
...
const useStyles = createThemedStyles((theme) => StyleSheet.create({
  ...
  // Banner
  bannerCard: { minHeight: 132, backgroundColor: theme.colors.primaryLight, borderWidth: 1, borderColor: theme.colors.primary, borderRadius: 16, padding: 24, overflow: 'hidden', position: 'relative', justifyContent: 'center', alignItems: 'center' },
  bannerGreetingLayer: { zIndex: 10, alignItems: 'center', justifyContent: 'center', width: '100%' },
  bannerTitle: { fontSize: 24, fontWeight: '700', color: theme.colors.textPrimary, marginBottom: 4, textAlign: 'center' },
  bannerSub: { fontSize: 14, color: theme.colors.textMuted, maxWidth: '86%', textAlign: 'center', lineHeight: 20 },
