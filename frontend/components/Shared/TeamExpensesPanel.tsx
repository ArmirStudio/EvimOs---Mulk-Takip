...
const useStyles = createThemedStyles((theme) =>
  StyleSheet.create({
    ...
    editBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 10, paddingVertical: 6, borderRadius: theme.borderRadius.md, backgroundColor: theme.colors.primaryLight },
    editBtnText: { fontSize: theme.fontSize.sm, fontWeight: '700', color: theme.colors.primary },
    deleteBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 10, paddingVertical: 6, borderRadius: theme.borderRadius.md, backgroundColor: theme.colors.errorLight },
